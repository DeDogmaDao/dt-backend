...
# CC_ADDR = "0x663f3ad617193148711d28f5334ee4ed07016602"
RCC_ADDRESS = "0x663f3ad617193148711d28f5334ee4ed07016602"
ABI = [
    {
      "inputs": [
        {
...
def run_fetch(url):
    ...
    # ERC721 = web3.eth.contract(address=web3.toChecksumAddress(RCC_ADDRESS), abi=ABI)
    state = State(ns)
    state.restore()
